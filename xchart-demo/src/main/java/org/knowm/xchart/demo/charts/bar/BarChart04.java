...
public class BarChart04 implements ExampleChart<CategoryChart> {
  ...
  public CategoryChart getChart() {
    ...
    // Series
    chart.addSeries("female", Arrays.asList(new Integer[] { 10, 20, 30, 40, 50 }), Arrays.asList(50, 10, 20, 40, 35));
    chart.addSeries("male", Arrays.asList(new Integer[] { 10, 20, 30, 40, 50 }), Arrays.asList(40, 30, 20, null, 60));
